<script lang="ts">
	...
	const handleToggleTodo = (
		{ detail: { completed } }: CustomEvent<TodoItemEvents['complete']>,
		todo: TodoItem,
	) => {
		...
		{#if todos.length}
			...
			<footer class="footer">
				<span class="todo-count">
					...
					{pluralized(activeTodoCount)} left
				</span>
				<ul class="filters">
					<!-- svelte-ignore a11y-missing-content -->
					<li><a href="/" class:selected={currentFilter === 'all'}>All</a></li>
					<!-- svelte-ignore a11y-missing-content -->
					<li><a href="/active" class:selected={currentFilter === 'active'}>Active</a></li>
					<!-- svelte-ignore a11y-missing-content -->
					<li><a href="/completed" class:selected={currentFilter === 'completed'}>Completed</a></li>
				</ul>
				{#if hasFinishedTodos}
